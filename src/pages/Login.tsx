      ...
      <Card className="w-full max-w-md animate-fade-in border-cashew-200 shadow-lg">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="#" className="text-xs text-cashew-600 hover:text-cashew-800 hover:underline">
                  Lupa kata sandi?
                </Link>
              </div>
        ...
        <CardFooter className="flex flex-col space-y-3 pb-6 pt-2">
          <div className="text-sm text-center text-cashew-600">
            Belum punya akun?{' '}
            <Link to="/register" className="font-medium text-cashew-700 hover:text-cashew-800 hover:underline transition-colors">
              Daftar
            </Link>
          </div>
        </CardFooter>
